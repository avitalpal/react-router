               ...
               <ul class="space-y-2">
                  <li>
                     <div class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <Link to="/homepage" class="ml-3 hover:text-violet-600 whitespace-pre-wrap truncate">Home Navigation</Link>
                     </div>
                  </li>
                  <li>
                     <div class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                  ...
                  <li>
                     <div class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <Link to="/basicpage" class="flex-1 ml-3 whitespace-pre-wrap hover:text-violet-600 truncate">Basic Routing</Link>
                     </div>
                  </li>
                  <li>
                     <div class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <Link to="/nestedpage" class="flex-1 ml-3 whitespace-pre-wrap hover:text-violet-600 truncate">Nested Routing</Link>
                     </div>
                  </li>
                  <li>
                     <div class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <Link to="/protpage" class="flex-1 ml-3 whitespace-pre-wrap hover:text-violet-600 truncate">Protected Links</Link>
                     </div>
                  </li>
                  <li>
                     <div class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                  ...
                  <li>
                     <div class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <Link to="https://www.notion.so/wizteam/React-Router-c5f0d013eeb7450aa1494fad2fea2f9ahttps://www.notion.so/wizteam/Tailwind-CSS-2c225a5743594306add3b59e8335c373#4c68e3d84cde44e1b6bd87734680ea8e" class="flex-1 ml-3 whitespace-pre-wrap hover:text-violet-600 truncate">Router Doc</Link>
                     </div>
                  </li>
